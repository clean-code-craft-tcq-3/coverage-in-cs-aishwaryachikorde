...
namespace TypewiseAlert.Test
{
  public class TypewiseAlertTest
  {
    ...
    public void InfersBreachAsPerLimits()
    {
      ...
      Assert.True(TypewiseAlert.InferBreach(50, 30, 50) == TypewiseAlert.BreachType.NORMAL);
    ...
    public void InfersBreachAsCoolingType()
    {
      ...
      Assert.False(TypewiseAlert.ClassifyTemperatureBreach(CoolingType.MED_ACTIVE_COOLING, 40) == TypewiseAlert.BreachType.TOO_HIGH);
    ...
    public void SendAlertsToEmailTests()
    {
      ...
      Assert.True(alertContextToEmail.sent);
    ...
    public void SendAlertsToControllerTests()
    {
      ...
      Assert.True(alertContextToController.sent);
